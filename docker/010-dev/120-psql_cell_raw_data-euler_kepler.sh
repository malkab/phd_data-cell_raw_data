...
# -----------------------------------------------------------------
#
# psql session to kepler's cell_raw_data from euler.
#
# -----------------------------------------------------------------
#
...
COMMAND=
# Container name
CONTAINER_NAME=$MLKC_CELL_RAW_DATA_APP_kepler_psql
# Container host name
CONTAINER_HOST_NAME=$MLKC_CELL_RAW_DATA_APP_kepler_psql
# Work dir
WORKDIR=/ext_src/
# The version of Docker PG image to use
POSTGIS_DOCKER_TAG=gargantuan_giraffe
# The host
HOST=$MLKC_CELL_RAW_DATA_IP
# The port
