...
# "localhost"
NETWORK=${MLKC_PHD_DATA_APP}_production_test
...
COMMAND=
# Container name
CONTAINER_NAME=${MLKC_PHD_DATA_APP}_psql_production_test
# Container host name
CONTAINER_HOST_NAME=${MLKC_PHD_DATA_APP}_psql_production_test
# Work dir
WORKDIR=/ext_src/
...
USER=postgres
# The pass
PASS=$MLKC_PHD_DATA_POSTGIS_PASSWORD
# The DB
DB=postgres
