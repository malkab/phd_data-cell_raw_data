...
# SSH
# -----
export MLKC_CELL_RAW_DATA_SSH_USER_NAME=$MLKC_37NORTH_USER
export MLKC_CELL_RAW_DATA_SSH_HOST=$MLKC_37NORTH_HOST
...
export MLKC_CELL_RAW_DATA_PG_MAX_CONNECTIONS=500
export MLKC_CELL_RAW_DATA_PG_SHARED_BUFFERS=16GB
